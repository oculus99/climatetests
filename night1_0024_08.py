...
tmean_planet=14
deltat_from_tmean=32
tmax_planet=tmean_planet+deltat_from_tmean
...
#global_moisture_coeff=oceanfrac 
 

 
print("Global moisture coeff ",global_moisture_coeff ) 
