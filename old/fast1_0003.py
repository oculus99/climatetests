...
def plot_temperature_curves(
    ...
    title = (
        f"{object_name} — Seasonal Temperature Curves\n"
        f"P = {p_orbit:.2f} d   |   "
        f"S = {S:.2f} W/m²   |   "
        f"tilt = {tilt:.2f}°   |   "
        f"ecc = {ecc:.5f}   |   "
...
if __name__ == "__main__":
    ...
    # ============================================================
    Tglobal_numpy = (
    results_numpy["Tglobal"]
    - 273.15
    )
    Tglobal_numba = (
    results_numba["Tglobal"]
    - 273.15
    )
    print()
    ...
    print(
    f"Difference    : "
    f"{Tglobal_numba - Tglobal_numpy:.6e} °C"
    )
    print("=" * 60)
    print("=" * 60)
    results=results_numba ## NOK
