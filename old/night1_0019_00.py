...
merenpinta_kynnys = 0.25   # Perlin-kynnysraja merelle/maalle (-1..1)
...
if HAS_NOISE:
    ...
    for i in range(korkeus):
        ...
        for j in range(leveys):
            ...
            # Mutkista kohinan koordinaatteja
            wx = x + warp_x * 0.45
            wy = y + warp_y * 0.45
            wz = z

            # ---------------------------------------------------------
            # 2. Pääasiallinen maastokohina
            # ---------------------------------------------------------
            n = pnoise3(
                (wx + 13.37) * scale,
                (wy + 42.42) * scale,
            ...
            # ---------------------------------------------------------
            # 5. Muodostetaan erillisiä vuoristoalueita
            # ---------------------------------------------------------
