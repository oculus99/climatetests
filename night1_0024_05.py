...
class PlanetMap:
    ...
    def _luo_referenssi(
        ...
        return PlanetReference(
            ...
            # Aluksi None.
            # Ensimmäinen kartta laskee tämän.
            merenpinta=None,
        )

    # ========================================================
    # MERENPINNAN ETSINTÄ TULVITUKSELLA
    # ========================================================
    ...
    def _etsi_merenpinta_tulvituksella(
        ...
        tarkoittaa, että noin 70 % kartan soluista
        määritetään mereksi.

        Longitude-suunnassa kartta wrapataan:
            x=0 <-> x=W-1

        Latitude-suunnassa ei wrapata.
        """

        if oceanfrac is None:
            return 0.0

        oceanfrac = float(oceanfrac)
        ...
        # ----------------------------------------------------
        # Aloitetaan kartan alimmasta kohdasta
        # ----------------------------------------------------
        ...
        while heap and maara < tavoite:

            korkeus, y, x = heapq.heappop(heap)
    ...
    def generoi_kartta(
        ...
        if referenssi is None:
            ...
            referenssi = self._luo_referenssi(
                octaves=octaves,
            ...
            # ------------------------------------------------
            # Meren osuus kuuluu referenssiin
            # ------------------------------------------------
        ...
        if referenssi.merenpinta is None:
            ...
            # ------------------------------------------------
            # Zoomauksessa käytetään AINA samaa merenpintaa
            # ------------------------------------------------
