...
planet_global_tmean=14
planet_deltat_from_tmean=40 #3 from mean temperetures to hottest pclaces

planet_tmax_default=planet_global_tmean+planet_deltat_from_tmean
...
def piirra_ilmastodiagrammi(
    ...
    piste_korkeus = korkeuskartta[row, col]
...
def laske_ilmasto_gpu(
    ...
    leveysaste_viilennys_kerroin=0.20 *math.sqrt(planet_radius_re)*math.sqrt(24/planet_rotation_hours)*(1/planet_atmosphere_pressure)*landfrac_vaikutus_leveysaste_viilennys
    ...
    lapse_rate=lapse_rate_helppo(tmax_default-20, planet_atmosphere_pressure*1013.25, gee, global_moisture_coeff)
...
kuukausi_merivirta_x_gpu, kuukausi_merivirta_y_gpu=laske_ilmasto_gpu(
    ...
    landfrac=landfrac,
    tmax_default=planet_tmax_default, ## 57
