...
def get_daily_temperature(
    ...
    # --------------------------------------------------------
    # Vuorokauden ensimmäinen timestep
    # --------------------------------------------------------
    ...
    if (
        step_start < 0
        or step_end > T_year.shape[0]
    ):

        raise ValueError(
            "Päivä ei mahdu tallennettuun vuoteen."
        )
...
def daily_insolation_numba(
    ...
    r, solar_longitude = orbital_position_numba(
        day,
        p_orbit,
        mvelp,
        ecc
    ...
    # DAILY MEAN COSZ
    #
    # Mean over the complete day.
    #
    # Negative night-time values are NOT included.
    # ========================================================
...
def main_ebm_numba(
    ...
    #
    # Orbit repeats every year.
    #
    # Q_year:
    #     daily mean insolation
    #
    # cosz_year:
    #     instantaneous geometrical cosz
    #
    # cosz_daylight_year:
    #     max(cosz, 0)
    #
    # cosz_daily_year:
    #     daily mean max(cosz, 0)
    # ========================================================
...
def plot_daily_temperature(
    ...
    if (
        ...
        raise ValueError(
            "Valittu päivä ei mahdu tallennettuun vuoteen."
        )

    # ========================================================
    # TIME OF DAY
    #
    # T_year contains temperature AFTER each timestep.
    #
    # Use timestep centers for plotting.
    # ========================================================
...
if __name__ == "__main__":
    ...
    time_h, T_day, lat_actual = get_daily_temperature(
    results, dt=dt,
    day=172,
    latitude=00.0
    )
